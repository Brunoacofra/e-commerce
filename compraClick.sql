...
CREATE TABLE Perguntas (
 ...
 per_ads_id INT NOT NULL,
 per_user_id INT NOT NULL,
 per_response TEXT,
 per_horario DATETIME,
 FOREIGN KEY (per_ads_id) REFERENCES ads(ads_id),
 FOREIGN KEY (per_user_id) REFERENCES usuario(usu_id)
);
-- Tabela de Compras
CREATE TABLE compra (
 com_id INT AUTO_INCREMENT PRIMARY KEY,
 com_ads_id INT NOT NULL,
 com_user_id INT NOT NULL,
 com_horario DATETIME ,
 FOREIGN KEY (com_ads_id) REFERENCES ads(ads_id),
 FOREIGN KEY (com_user_id) REFERENCES usuario(usu_id)
);
-- Tabela de Favoritos
